  ...
  return (
    <article className="max-w-4xl mx-auto">
      ...
      <header className="mb-8">
        ...
        <p className="text-xl text-gray-600 mb-4">{p.subtitle}</p>

        {/* Meta */}
        <div className="flex flex-wrap gap-4 text-sm text-gray-500">
          {p.company && (
            <span>
              <span className="font-medium">{t.company}:</span> {p.company}
            </span>
          )}
          <span>
            <span className="font-medium">{t.role}:</span> {p.role.join(", ")}
          </span>
        </div>
      </header>
      ...
      <div className="space-y-10">
        {/* Summary */}
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mb-3">{t.overview}</h2>
          <p className="text-gray-700 leading-relaxed">{p.summary}</p>
        </section>

        {/* Problem */}
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mb-3">{t.problem}</h2>
          <p className="text-gray-700 leading-relaxed">{p.problem}</p>
        </section>

        {/* Solution */}
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mb-3">{t.solution}</h2>
        ...
        {p.architectureImage && (
          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-3">{t.architecture}</h2>
            <div className="relative aspect-video bg-gray-100 rounded-lg overflow-hidden border border-gray-200">
              <Image
        ...
        {p.achievements.length > 0 && (
          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-3">{t.achievements}</h2>
            <ul className="list-disc list-inside space-y-2 text-gray-700">
        ...
        {p.lessonsLearned && (
          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-3">{t.lessonsLearned}</h2>
        ...
        {/* Tech Stack */}
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mb-3">{t.techStack}</h2>
        ...
        {(p.externalUrl || p.repositoryUrl) && (
          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-3">{t.links}</h2>
